                            ...
                            <div class="card-body p-4">
                                <div class="media ai-icon">
                                    <span class="me-3 bgl-warning text-warning">
                                        <svg id="icon-orders" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text">
                            ...
                            <div class="card-body p-4">
                                <div class="media ai-icon">
                                    <span class="me-3 bgl-success text-success">
                                        <svg id="icon-database-widget" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database">
                                ...
                                <div className="tbl-caption">
                                    <div className="row p-3 ">
                                        <div className="col-md-6">
                                            <a href='/' className="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#basicModal" >+ Add Punchlist</a>
                                        </div>
                                    ...
                                    <div className="basic-form">
                                        ...
                                        <div className="row">
                                            <div class="form-check custom-checkbox mx-3 mb-3" onClick={hideOptional}>
                                                ...
                                                {/* </div> */}
                                                {/* <div className="col-sm-9"> */}
                                                <label class="form-check-label" htmlFor="customCheckBox1">After Photo</label>
                                                {/* </div> */}
                                            </div>
                                        </div>
                                        {/* <div className="mb-3 row">
                                        ...
                                        <div className="row">
                                            <div class="form-check custom-checkbox mx-3">
                                                ...
                                                {/* </div> */}
                                                {/* <div className="col-sm-9"> */}
                                                <label class="form-check-label" htmlFor="customCheckBox2">Complete ?</label>
                                                {/* </div> */}
                                            </div>
                                        </div>
                                    </div>
