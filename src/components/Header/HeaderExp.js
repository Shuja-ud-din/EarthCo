...
const HeaderExp = () => {
    ...
    const { mainControl, setMainControl, setShowSM, eliminate } = useContext(StyleContext)
    ...
    const toggleSideBar = () => {
        if (screenWidth > 450) {
            ...
            if (mainControl === 'desktop' || mainControl === 'tab' || mainControl === 'mobileH') {
                                                ...
                                                <div className="card border-0 mb-0">
                                                    ...
                                                    <div className="card-body px-0 py-0">
                                                        <ul>
                                                            ...
                                                            <li className="dropdown-item ai-icon ">
                                                                <svg xmlns="http://www.w3.org/2000/svg" color='#789a3d' width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
